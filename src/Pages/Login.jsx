...
const Login = () => {  
  ...
  async function handlelogin(data){ 
    console.log("inside");     
        try {
            var res=await axios.post('http://localhost:8080/api/v1/platform/auth/login',data);
            console.log(res);
            if(res.data.token){
    ...
    console.log(isAuth,"ageter loginnnn")
    if(loginAuth){
        return navigate("/");
    }
  ...
  return (
    ...
    <img className='image' src='data:image/jpeg;base64,' alt='login_img'/>
        ...
        <div className='login_form'>
         <div>
            <h3>Welcome , Again👋</h3>
            <p>dolorum atque eius earum! Dolor excepturi nemo deleniti fugiat labore recusandae praesentium?</p>
         </div>           
            <input placeholder='Enter email' value={email} name="email" onChange={handlechange}/>           
            <input  placeholder='Enter Password' value={password} name="password" onChange={handlechange} />
            <button onClick={()=>handlelogin(state)}>Login</button> 
            <div>
                <h5>If already have account ,signup!</h5>
